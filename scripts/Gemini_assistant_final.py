...
class CameraThread(threading.Thread):
    ...
    def run(self):
        ...
        _cv2.namedWindow("Gemini_assistant_final", _cv2.WINDOW_NORMAL)
        _cv2.resizeWindow("Gemini_assistant_final", 960, 540)
        last_send = 0.0
        ...
        try:
            while not self.stop_evt.is_set():
                ...
                _cv2.imshow("Gemini_assistant_final", frame)
